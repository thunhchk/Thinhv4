...
Main1=Window:AddTab({ Title="tab Fram Other" }),
    ...
    Race=Window:AddTab({ Title="tab race v4" }),
...
Button.Image = "rbxassetid://5009915795"
    ...
    function getHighestPoint()
        ...
        for _, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v:IsA("MeshPart") then
                if v.MeshId=="rbxassetid://5009915795" then
                    return v
                end
            end
        end
...
local ToggleAutoKen = Tabs.Setting:AddToggle("ToggleAutoKen", {Title="Auto haki quang sát", Description="", Default=false })
...
local Mastery = Tabs.Raid:AddSection("bay tới Raid Law")
...
if currentTime - lastNotificationTime >= notificationCooldown then
    game.StarterGui:SetCore("SendNotification", {
        Title = "khởi động thành công rồi người đẹp....",
        Duration = 1
    })
